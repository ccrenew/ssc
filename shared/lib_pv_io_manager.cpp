...
void PVSystem_IO::AllocateOutputs(compute_module* cm)
{
	...
	for (size_t subarray = 0; subarray < Subarrays.size(); subarray++)
	{
		if (Subarrays[subarray]->enable)
		{
			...
			p_poaNominalFrontBeam.push_back(cm->allocate(prefix + "poa_nom_beam", numberOfWeatherFileRecords));
			p_poaNominalFrontSky.push_back(cm->allocate(prefix + "poa_nom_sky", numberOfWeatherFileRecords));
			p_poaNominalFrontGnd.push_back(cm->allocate(prefix + "poa_nom_gnd", numberOfWeatherFileRecords));
			p_poaShadedFront.push_back(cm->allocate(prefix + "poa_shaded", numberOfWeatherFileRecords));
			p_poaShadedFrontBeam.push_back(cm->allocate(prefix + "poa_shaded_beam", numberOfWeatherFileRecords));
			p_poaShadedFrontSky.push_back(cm->allocate(prefix + "poa_shaded_sky", numberOfWeatherFileRecords));
			p_poaShadedFrontGnd.push_back(cm->allocate(prefix + "poa_shaded_gnd", numberOfWeatherFileRecords));
			p_poaShadedSoiledFront.push_back(cm->allocate(prefix + "poa_shaded_soiled", numberOfWeatherFileRecords));
			p_poaBeamFront.push_back(cm->allocate(prefix + "poa_shaded_soiled_beam", numberOfWeatherFileRecords));
			p_poaDiffuseFront.push_back(cm->allocate(prefix + "poa_shaded_soiled_diff", numberOfWeatherFileRecords));
			p_poaSoiledFrontSky.push_back(cm->allocate(prefix + "poa_shaded_soiled_sky", numberOfWeatherFileRecords));
			p_poaSoiledFrontGnd.push_back(cm->allocate(prefix + "poa_shaded_soiled_gnd", numberOfWeatherFileRecords));
			p_poaTotal.push_back(cm->allocate(prefix + "poa_eff", numberOfWeatherFileRecords));
			p_poaRear.push_back(cm->allocate(prefix + "poa_eff_rear", numberOfWeatherFileRecords));
			p_poaFront.push_back(cm->allocate(prefix + "poa_eff_front", numberOfWeatherFileRecords));
